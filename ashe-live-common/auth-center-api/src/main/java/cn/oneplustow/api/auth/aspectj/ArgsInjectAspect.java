package cn.oneplustow.api.auth.aspectj;
...
import cn.oneplustow.api.auth.annoatation.ArgsInject;
...
public class ArgsInjectAspect {
    ...
    @Pointcut("@annotation(cn.oneplustow.api.auth.annoatation.ArgsInject)")

...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(cn.oneplustow.user.aspectj.lang.annotation.DataScope)")
    ...
    protected void handleDataScope(final JoinPoint joinPoint)
    {
        ...
        SysUserModel currentUser = loginUser.getUser();
        if (currentUser != null)
        {
            // 如果是超级管理员，则不过滤数据
     ...
     * @param alias 别名
     */
    public static void dataScopeFilter(JoinPoint joinPoint, SysUserModel user, String deptAlias, String userAlias)
    {

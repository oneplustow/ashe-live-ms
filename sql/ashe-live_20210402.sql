...
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2001, '订单管理', 0, 2, 'order-management', NULL, 1, 'M', '0', NULL, 'list', 'admin', '2020-02-23 08:53:48', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2002, '商品管理', 0, 1, 'commodity-management', NULL, 1, 'M', '0', '', 'shopping', 'admin', '2020-02-23 08:55:12', 'admin', '2020-02-25 10:30:21', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2003, '订单列表', 2001, 1, 'order-list', 'order-management/order-list', 1, 'C', '0', 'system:order:page', 'list', 'admin', '2020-02-23 08:56:13', 'admin', '2020-02-28 12:16:12', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2005, '商品列表', 2002, 1, 'commodity-editor', 'commodity-management/commodity-editor', 1, 'C', '0', 'system:foCommodity:page', 'edit', 'admin', '2020-02-23 09:00:20', 'admin', '2020-02-28 12:51:03', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2009, '物流日志管理', 0, 6, 'logistical-log', NULL, 1, 'M', '1', '', 'guide', 'admin', '2020-02-25 10:25:43', 'admin', '2020-03-06 01:54:25', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2010, '物流日志查看', 2009, 1, 'logistical-log-view', 'logistical-log/logistical-log-view', 1, 'C', '0', '', 'eye-open', 'admin', '2020-02-25 10:28:31', 'admin', '2020-02-27 22:12:27', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2011, '保存订单', 2003, 1, '', NULL, 1, 'F', '0', 'system:order:save', '#', 'admin', '2020-02-28 12:16:44', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2012, '查询订单', 2003, 2, '', NULL, 1, 'F', '0', 'system:order:one', '#', 'admin', '2020-02-28 12:17:12', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2013, '删除订单', 2003, 3, '', NULL, 1, 'F', '0', 'system:order:del', '#', 'admin', '2020-02-28 12:17:38', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2014, '确认订单', 2003, 4, '', NULL, 1, 'F', '0', 'system:order:affirmOrder', '#', 'admin', '2020-02-28 12:17:53', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2015, '确认收货', 2003, 5, '', NULL, 1, 'F', '0', 'system:order:alreadyOrder', '#', 'admin', '2020-02-28 12:18:12', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2016, '配货管理', 0, 3, 'distribution-order', NULL, 1, 'M', '0', '', 'list', 'admin', '2020-02-28 15:34:03', 'admin', '2020-02-28 15:34:17', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2017, '发货管理', 0, 4, 'shipment-order', NULL, 1, 'M', '0', NULL, 'list', 'admin', '2020-02-28 15:34:52', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2018, '结算管理', 0, 5, 'statement-order', NULL, 1, 'M', '0', NULL, 'list', 'admin', '2020-02-28 15:35:21', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2019, '配货单列表', 2016, 1, 'distributionOrder-list', 'distribution-order/distributionOrder-list', 1, 'C', '0', NULL, 'list', 'admin', '2020-02-28 15:37:25', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2020, '发货单列表', 2017, 1, 'shipmentOrder-list', 'shipment-order/shipmentOrder-list', 1, 'C', '0', NULL, 'list', 'admin', '2020-02-28 15:39:19', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2021, '结算单列表', 2018, 1, 'statementOrder-list', 'statement-order/statementOrder-list', 1, 'C', '0', NULL, 'list', 'admin', '2020-02-28 15:40:06', '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2022, '取消订单', 2003, 6, '', NULL, 1, 'F', '0', 'system:order:cancelOrder', '#', 'admin', '2020-02-29 15:32:44', '', NULL, '');
...
INSERT INTO sys_dict_data VALUES (2, 2, '女', '1', 'sys_user_sex', '', '', 'N', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2020-03-03 17:42:06', '性别女');
...
CREATE TABLE `sys_seq_history` (
  `id`                    varbinary(32)    NOT NULL                                COMMENT 'id',
  `seqid`                 varbinary(32)    NOT NULL                                COMMENT '编码id',
  `tenant_entity_name`    varchar(200)     COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实体名',
  `tenant_entity_id`      varbinary(32)    DEFAULT NULL                            COMMENT '实体id',
  `seq_code`              varchar(200)     COLLATE utf8mb4_unicode_ci DEFAULT ''   COMMENT '编码值',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE `sys_seq_recycle` (
  `id`             varbinary(32)      NOT NULL                            COMMENT 'id',
  `seq_id`         varbinary(32)      NOT NULL                            COMMENT '编码id',
  `seq_code`       varchar(200)       COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '编码',
  `is_recycled`    varchar(100)       COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '回收状态',
  PRIMARY KEY (`id`),
  KEY `FK_SEQ_RECYCLE_REF` (`SEQ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE `sys_seq_rule` (
  `id`             varbinary(32) NOT NULL                                   COMMENT '规则id',
  `seq_id`         varbinary(32) NOT NULL                                   COMMENT '编码id',
  `rule_order`     int(2) NOT NULL                                          COMMENT '规则顺序号',
  `rule_type`      varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL         COMMENT '规则类型',
  `rule_value`     varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL     COMMENT '规则参数',
  `padding_side`   varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL     COMMENT '补齐方向',
  `padding_width`  bigint(4) DEFAULT NULL                                   COMMENT '补齐长度',
  `padding_char`   varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL     COMMENT '补齐内容',
  `step`           bigint(3) DEFAULT NULL                                   COMMENT '步长',
  `start_no`       bigint(20) DEFAULT NULL                                  COMMENT '起始序号',
  `current_no`     bigint(20) DEFAULT NULL                                  COMMENT '当前序号',
  `reset_flag`     varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL     COMMENT '重置标志',
  `reset_type`     varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL     COMMENT '重置类型',
...
CREATE TABLE `sys_sequence` (
  `id`            varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '编码id',
  `seq_name`      varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '编码名称',
  `delimiter`     varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '分隔符',
  `need_recycle`  varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '是否可回收',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
